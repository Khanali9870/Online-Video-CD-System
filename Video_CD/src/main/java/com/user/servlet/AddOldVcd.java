...
@WebServlet("/add_old_vcd")
@MultipartConfig
public class AddOldVcd extends HttpServlet {
	@Override
	protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		try {
			...
			VcdDetails v = new VcdDetails(vcdName, actors, price, catogories, status, fileName, useremail);
			...
			if (f) {
				...
				resp.sendRedirect("sell_vcd.jsp");
			} else {
